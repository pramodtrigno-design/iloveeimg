...
export const metadata: Metadata = {
    ...
    openGraph: { title: "Merge PDF Online — Combine Multiple PDFs Into One Free", description: "Merge and combine multiple PDF files into a single document online for free.", url: "/merge" },
};
